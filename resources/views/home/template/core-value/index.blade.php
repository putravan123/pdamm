    ...
    <div class="container-fluid blog py-5">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5" style="max-width: 800px;">
                ...
                <h1 class="display-3 text-capitalize mb-3">core Value</h1>
            </div>
            <div class="row g-4 justify-content-center">
                @foreach($coreValue as $galeris)
                    <div class="col-lg-6 col-xl-4 col-md-6 col-12">
                        <div class="blog-item">
                            <div class="blog-img" onclick="openImageModal('{{ asset('storage/' . $galeris->image) }}')">
                                <img src="{{ asset('storage/' . $galeris->image) }}" class="img-fluid rounded-top w-100" alt="{{ $galeris->title }}" style="height: 300px; object-fit: cover; cursor: pointer;">
                            </div>
                        </div>
                    </div>
                @endforeach
